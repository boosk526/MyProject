...
<link href="../resources/css/info/discography.css" rel="stylesheet" type="text/css">
<head>
<title>profile</title>
<meta charset="utf-8">
<body>
      	...
      	<div class="discography-album">
      		<ul class="caption-style">
				<li class="album-all min-bor">
					...
					<div class="caption">
						<a href="${pageContext.request.contextPath}/info/discographyDetailBlue">
							<div class="blur"></div>
				...
				<li class="album-all">
					...
					<div class="caption">
					<a href="${pageContext.request.contextPath}/info/discographyDetailEternity">
						<div class="blur"></div>
						<div class="caption-text">
							2RD MINI ALBUM<br>
			      			<h3>꿈의 장 : ETERNITY</h3>
				...
				<li class="album-all">
					...
					<div class="caption">
						<a href="${pageContext.request.contextPath}/info/discographyDetailMagic">
							<div class="blur"></div>
							<div class="caption-text">
				...
				<li class="album-all">
					...
					<div class="caption">
						<a href="${pageContext.request.contextPath}/info/discographyDetailStar">
							<div class="blur"></div>
							<div class="caption-text">
								1ST MINI ALBUM<br>
			      				<h3>꿈의 장 : STAR</h3>
